...
Data is required to have at least three columns, Sale Year, Sale Price, and Assessed Value. Assessments and sales should typically be from the same year.
...
#cmfproperty::plots(ratios, 2002, 2018, "Columbus, Ohio")
...
This package fully loads `ggplot2`.
